$(function(){
  ...
  $('.events-monthly-ratio').on('change', '.select', function() {
    ...
    if ($(this).hasClass('type')) {
      $title.text(val == 1 ? '特殊人群区域分布情况' :
                  val == 2 ? '特殊人群月环比' : '特殊人群年同比');
    }
    getEventsMonthlyRatioData();
  })
  ...
  /* 婚姻比例 */
  function getMarriageRatioData() {
    var marriageRatioData = {
      names: ['未婚','已婚','离婚','丧偶'],
      data: [{
        name: '未婚',
        value: 1080,
    ...
    pieChart('marriageRatio', marriageRatioData)
  }
