...
barAndLineChartFun($('#SecurityKey'), SecurityKeyData,{legendType: 'bottomCenter'});
  //饼状图
  var SecurityKeyRatioData = {
    echartData: [
      {
        value: 2154,
        name: "男性",
  ...
  pieEchats("SecurityKeyRatio", SecurityKeyRatioData)
